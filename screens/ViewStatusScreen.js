...
export default class MikroStatusScreen extends React.Component {
    static navigationOptions = ({ navigation }) => {
        return {
            title: " Wzkażniki Organoleptyczne",
            headerTitleStyle: {
                textAlign: "center",
                alignSelf: "center",
                width: '70%'
                ...
                <View style={styles.body}>
                    <View style={styles.keyList}>
                        ...
                        <ScrollView contentContainerStyle={styles.scroll}>
                            <Text style={{...styles.keyValue, ...{color: this.statusColor(status.colorStatus)}}}>Barwa {data.color}/5</Text>
                            <Text style={{...styles.keyValue, ...{color: this.statusColor(status.smellStatus)}}}>Zapach {data.smell}/5</Text>
                        </ScrollView>
                    </View>
                </View>
            </ImageBackground>);
