                ...
                <View style={styles.body}>
                    <View style={styles.keyList}>
                        ...
                        <ScrollView contentContainerStyle={styles.scroll}>
                            <Text style={{...styles.keyValue, ...{color: this.statusColor(status.bacteriaStatus)}}}>Ogólna liczba bakterii {data.bacteria}/50</Text>
                            <Text style={{...styles.keyValue, ...{color: this.statusColor(status.ecolaStatus)}}}>ECola {data.ecola ? 'obecna' : 'brak'}</Text>
                        </ScrollView>
                    </View>
                </View>
            </ImageBackground>);
